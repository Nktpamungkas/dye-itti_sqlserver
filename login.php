...
if ($_POST) {
  ...
  $sql = sqlsrv_query($con, "SELECT TOP 1 * FROM db_dying.tbl_user WHERE username='$username' AND password='$password' AND (dept='DYE' OR dept='DIT')", array(), array("Scrollable" => SQLSRV_CURSOR_KEYSET));
