				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input name="nokk" type="text" class="form-control" id="nokk"
							onchange="window.location='?p=Form-Monitoring-CB&nokk='+this.value"
		...
		-->
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input name="sc1" type="text" class="form-control" id="sc1" value="" placeholder="0">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input name="sc2" type="text" class="form-control" id="sc2" value="" placeholder="0">
							<span class="input-group-addon">&deg;C</span>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input name="sc3" type="text" class="form-control" id="sc3" value="" placeholder="0">
							<span class="input-group-addon">&deg;C</span>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input name="sc4" type="text" class="form-control" id="sc4" value="" placeholder="0">
							<span class="input-group-addon">&deg;C</span>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input name="sk" type="text" class="form-control" id="sk" value="" placeholder="0">
							<span class="input-group-addon">&deg;C</span>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input name="stm" type="text" class="form-control" id="stm" value="" placeholder="0">
							<span class="input-group-addon">&deg;C</span>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input name="ws_abc" type="text" class="form-control" id="ws_abc" value="" placeholder="0">
							<span class="input-group-addon">&deg;C</span>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input name="ws" type="text" class="form-control" id="ws" value="" placeholder="0">
							<span class="input-group-addon">&deg;C</span </div>
						</div>
					</div>
				</div>
				<div class="form-group">
...
if ($_POST['save'] == "save") {
	...
	if ($_POST['sc1'] != NULL or $_POST['sc1'] != '') {
		$sc1 = $_POST['sc1'];
	} else {
		$sc1 = NULL;
	}
	if ($_POST['sc2'] != NULL or $_POST['sc2'] != '') {
		$sc2 = $_POST['sc2'];
	} else {
		$sc2 = NULL;
	}
	if ($_POST['sc3'] != NULL or $_POST['sc3'] != '') {
		$sc3 = $_POST['sc3'];
	} else {
		$sc3 = NULL;
	}
	if ($_POST['sc4'] != NULL or $_POST['sc4'] != '') {
		$sc4 = $_POST['sc4'];
	} else {
		$sc4 = NULL;
	}
	if ($_POST['sk'] != NULL or $_POST['sk'] != '') {
		$sk = $_POST['sk'];
	} else {
		$sk = NULL;
	}
	if ($_POST['stm'] != NULL or $_POST['stm'] != '') {
		$stm = $_POST['stm'];
	} else {
		$stm = NULL;
	}
	if ($_POST['ws_abc'] != NULL or $_POST['ws_abc'] != '') {
		$ws_abc = $_POST['ws_abc'];
	} else {
		$ws_abc = NULL;
	}
	if ($_POST['ws'] != NULL or $_POST['ws'] != '') {
		$ws = $_POST['ws'];
	} else {
		$ws = NULL;
	}
	...
	$sqlData = "INSERT INTO db_dying.tbl_montemp (
		id_schedule,
		nokk,
		operator,
		colorist,
		...
		tgl_update) 
		VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	$stmt = sqlsrv_prepare($con, $sqlData, $datainsert);
