...
$qry=mysqli_query($con,"SELECT a.*,t_jawab,t_jawab1,t_jawab2,alasan,b.warna1,b.warna2,b.warna3,b.kg1,b.kg2,b.kg3,b.pjg1,b.pjg2,b.pjg3,b.satuan1,b.satuan2,b.satuan3,b.sebab,b.analisa,b.pencegahan,b.nokk1,b.nokk2,b.nokk3 FROM tbl_gantikain a
...
<table>
  ...
  <tr>
	...
	border-bottom:0px #000000 solid;
	border-left:0px #000000 solid; 
	border-right:0px #000000 solid;"><?php if($r['sebab']=="Man"){ echo "&#9745;";}else{ echo "&#9744;";}?></td>
	...
	border-bottom:0px #000000 solid;
	border-left:0px #000000 solid; 
	border-right:0px #000000 solid;"><?php if($r['sebab']=="Methode"){ echo "&#9745;";}else{ echo "&#9744;";}?></td>
                    <td style="border-top:0px #000000 solid; 
	border-bottom:0px #000000 solid;
	border-left:0px #000000 solid; 
	...
	border-bottom:0px #000000 solid;
	border-left:0px #000000 solid; 
	border-right:0px #000000 solid;"><?php if($r['sebab']=="Machine"){ echo "&#9745;";}else{ echo "&#9744;";}?></td>
                    <td style="border-top:0px #000000 solid; 
	border-bottom:0px #000000 solid;
	border-left:0px #000000 solid; 
	...
	border-bottom:0px #000000 solid;
	border-left:0px #000000 solid; 
	border-right:0px #000000 solid;"><?php if($r['sebab']=="Material"){ echo "&#9745;";}else{ echo "&#9744;";}?></td>
                    <td style="border-top:0px #000000 solid; 
	border-bottom:0px #000000 solid;
	border-left:0px #000000 solid; 
	...
	border-bottom:0px #000000 solid;
	border-left:0px #000000 solid; 
	border-right:0px #000000 solid;"><?php if($r['sebab']=="Environment"){ echo "&#9745;";}else{ echo "&#9744;";}?></td>
                    <td style="border-top:0px #000000 solid; 
	border-bottom:0px #000000 solid;
	border-left:0px #000000 solid; 
	...
	border-right:0px #000000 solid;"><?php echo $r['pencegahan'];?></span></td>
          ...
          <tr>
            <td colspan="3" valign="top" style="height: 0.9in; border-right:0px #000000 solid;">1. Warna =              <span style="font-size: 8px;"><?php echo $r['warna1'];?></span><br>
              <br /><?php $qr1=mysqli_query($con,"SELECT * FROM tbl_gantikain WHERE nokk='$r[nokk1]'");$rk1=mysqli_fetch_array($qr1); ?>
	...
	border-right:0px #000000 solid;" ><?php echo $r['kg1'];?> Kg<br><?php echo $r['pjg1']." ".$r['satuan1'];?> <?php if($r['pjg1']!=""){ ?><br>(Netto)<?php } ?></td>
            <td colspan="2" valign="top" style="height: 0.8in; border-right:0px #000000 solid;">2. Warna = <span style="font-size: 8px;"><?php echo $r['warna2'];?></span><br>
              <br />
              <?php $qr2=mysqli_query($con,"SELECT * FROM tbl_gantikain WHERE nokk='$r[nokk2]'");$rk2=mysqli_fetch_array($qr2); ?>
	...
	border-right:0px #000000 solid;">
            ...
            <td width="20%" valign="top" style="border-right:0px #000000 solid;"><span style="height: 0.8in; border-right:0px #000000 solid;">3. Warna = <span style="font-size: 8px;"><?php echo $r['warna3'];?></span><br>
              <br />
              <?php $qr3=mysqli_query($con,"SELECT * FROM tbl_gantikain WHERE nokk='$r[nokk3]'");$rk3=mysqli_fetch_array($qr3); ?>
