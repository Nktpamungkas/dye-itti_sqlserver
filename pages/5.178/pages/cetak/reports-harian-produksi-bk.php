...
WHERE
   ...
   $c=0;
    ...
    while($rowd=mysql_fetch_array($sql)){
      ...
      <td><div align="center"><?php if($rowd['tgl_out']!=""){$rol=$rowd['rol'];}else{ $rol=" "; } echo $rol; ?></div></td>
      <td><div align="right"><?php if($rowd['tgl_out']!=""){$brt=$rowd['bruto'];}else{ $brt=" "; } echo $brt; ?></div></td>
      <td><?php echo $rowd['proses']; ?></td>
      <td><?php echo $rowd['ket']."<br>".$rowd['status']; ?></td>
