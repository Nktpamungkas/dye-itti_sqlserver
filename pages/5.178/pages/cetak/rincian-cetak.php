...
<table width="100%" border="0">
  ...
  $sqlR=mysqli_query($con,"SELECT
	b.ket_status,
	b.proses,
	sum(IF(resep = 'Baru' and b.bruto > 200, 1, 0)) AS 'RB',
    sum(IF(resep = 'Baru' and b.bruto > 200, b.bruto, 0)) AS 'qtyRB',
	sum(IF(resep = 'Lama' and b.bruto > 200, 1, 0)) AS 'RL',
	sum(IF(resep = 'Lama' and b.bruto > 200, b.bruto, 0)) AS 'qtyRL',
    sum(IF(resep = 'Baru' and b.bruto > 0 and b.bruto < 200, 1, 0)) AS 'RB1',
    sum(IF(resep = 'Baru' and b.bruto > 0 and b.bruto < 200, b.bruto, 0)) AS 'qtyRB1',
	sum(IF(resep = 'Lama' and b.bruto > 0 and b.bruto < 200, 1, 0)) AS 'RL1',
	sum(IF(resep = 'Lama' and b.bruto > 0 and b.bruto < 200, b.bruto, 0)) AS 'qtyRL1',
	sum(IF(resep = 'Baru' and b.bruto > 200 and buyer='ADIDAS', 1, 0)) AS 'RBadidas',
	sum(IF(resep = 'Baru' and b.bruto > 200 and buyer='ADIDAS', b.bruto, 0)) AS 'qtyRBadidas',
	sum(IF(resep = 'Lama' and b.bruto > 200 and buyer='ADIDAS', 1, 0)) AS 'RLadidas',
    sum(IF(resep = 'Lama' and b.bruto > 200 and buyer='ADIDAS', b.bruto, 0)) AS 'qtyRLadidas',
    sum(IF(resep = 'Baru' and b.bruto > 0 and b.bruto < 200 and buyer='ADIDAS', 1, 0)) AS 'RBadidas1',
    sum(IF(resep = 'Baru'and b.bruto > 0 and b.bruto < 200 and buyer='ADIDAS', b.bruto, 0)) AS 'qtyRBadidas1',
    sum(IF(resep = 'Lama' and b.bruto > 0 and b.bruto < 200 and buyer='ADIDAS', 1, 0)) AS 'RLadidas1',
    sum(IF(resep = 'Lama' and b.bruto > 0 and b.bruto < 200 and buyer='ADIDAS', b.bruto, 0)) AS 'qtyRLadidas1',
...
<table width="100%" border="0" class="table-list1">
  ...
  $sqlx=mysqli_query($con,"SELECT
	k_resep,
	sum(IF(resep = 'Baru' and b.bruto > 200 and a.proses='Celup Greige', 1, 0)) AS 'RB',
  sum(IF(resep = 'Baru' and b.bruto > 200 and a.proses='Celup Greige', b.bruto, 0)) AS 'qtyRB',
	sum(IF(resep = 'Lama' and b.bruto > 200 and a.proses='Celup Greige', 1, 0)) AS 'RL',
	sum(IF(resep = 'Lama' and b.bruto > 200 and a.proses='Celup Greige', b.bruto, 0)) AS 'qtyRL',
  sum(IF(resep = 'Baru' and b.bruto > 0 and b.bruto < 200 and a.proses='Celup Greige', 1, 0)) AS 'RB1',
  sum(IF(resep = 'Baru' and b.bruto > 0 and b.bruto < 200 and a.proses='Celup Greige', b.bruto, 0)) AS 'qtyRB1',
	sum(IF(resep = 'Lama' and b.bruto > 0 and b.bruto < 200 and a.proses='Celup Greige', 1, 0)) AS 'RL1',
	sum(IF(resep = 'Lama' and b.bruto > 0 and b.bruto < 200 and a.proses='Celup Greige', b.bruto, 0)) AS 'qtyRL1',
	sum(IF(resep = 'Baru' and b.bruto > 200 and buyer='ADIDAS' and a.proses='Celup Greige', 1, 0)) AS 'RBadidas',
	sum(IF(resep = 'Baru' and b.bruto > 200 and buyer='ADIDAS' and a.proses='Celup Greige', b.bruto, 0)) AS 'qtyRBadidas',
	sum(IF(resep = 'Lama' and b.bruto > 200 and buyer='ADIDAS' and a.proses='Celup Greige', 1, 0)) AS 'RLadidas',
  sum(IF(resep = 'Lama' and b.bruto > 200 and buyer='ADIDAS' and a.proses='Celup Greige', b.bruto, 0)) AS 'qtyRLadidas',
  sum(IF(resep = 'Baru' and b.bruto > 0 and b.bruto < 200 and buyer='ADIDAS' and a.proses='Celup Greige', 1, 0)) AS 'RBadidas1',
  sum(IF(resep = 'Baru'and b.bruto > 0 and b.bruto < 200 and buyer='ADIDAS' and a.proses='Celup Greige', b.bruto, 0)) AS 'qtyRBadidas1',
  sum(IF(resep = 'Lama' and b.bruto > 0 and b.bruto < 200 and buyer='ADIDAS' and a.proses='Celup Greige', 1, 0)) AS 'RLadidas1',
  sum(IF(resep = 'Lama' and b.bruto > 0 and b.bruto < 200 and buyer='ADIDAS' and a.proses='Celup Greige', b.bruto, 0)) AS 'qtyRLadidas1',
	if(ISNULL(a.g_shift),b.g_shift,a.g_shift) as shft	
FROM
	tbl_schedule b
	LEFT JOIN  tbl_montemp c ON c.id_schedule = b.id
...
<table width="100%" border="0" class="table-list1">
  ...
  ROUND(AVG(IF(resep = 'Baru', 1, 0))) AS 'RB',
  ROUND(AVG(IF(resep = 'Lama', 1, 0))) AS 'RL',
	ROUND(AVG(IF(buyer='ADIDAS', b.bruto, 0)),2) AS 'qtyadidas',
	ROUND(AVG(IF(buyer='ADIDAS', c.pakai_air, 0))) AS 'airadidas',
  ROUND(AVG(IF(resep = 'Baru' and buyer='ADIDAS', 1, 0))) AS 'RBadidas',
  ROUND(AVG(IF(resep = 'Lama' and buyer='ADIDAS', 1, 0))) AS 'RLadidas',
...
WHERE
$shft 
	(DATE_FORMAT(a.tgl_buat,'%Y-%m-%d %H:%i') BETWEEN '$Awal' AND '$Akhir') AND (a.kd_stop='PT' or a.kd_stop='PM')
