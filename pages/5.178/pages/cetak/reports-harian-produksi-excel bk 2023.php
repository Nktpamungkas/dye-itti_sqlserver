...
WHERE
   ...
   $totberat=0;
    ...
    while($rowd=mysqli_fetch_array($sql)){
      ...
      <td><?php if($rowd['langganan']=="" AND substr($rowd['proses'],0,10)!="Cuci Mesin"){ echo $rowSM['keterangan']."".$rowSM['no_stop'];} else{echo $rowd['ket']."".$rowd['status'];} ?><?php if($rowd['kk_kestabilan']=="1" and $rowd['kk_normal']=="0"){echo "<br>Test Kestabilan";}?></td>
      ...
      <td><?php if($rowd['langganan']=="" AND substr($rowd['proses'],0,10)!="Cuci Mesin"){ echo $rowSM['tgl_masuk'] ;}else{echo $rowd['t_mulai'];} ?></td>
      <td><?php if($rowd['langganan']=="" AND substr($rowd['proses'],0,10)!="Cuci Mesin"){ echo $rowSM['jam_masuk'] ;}else{echo $rowd['j_mulai'];} ?></td>
      <td><?php if($rowd['langganan']=="" AND substr($rowd['proses'],0,10)!="Cuci Mesin"){ echo $rowSM['tgl_selesai'] ;}else{echo $rowd['t_selesai'];} ?></td>
      <td><?php if($rowd['langganan']=="" AND substr($rowd['proses'],0,10)!="Cuci Mesin"){ echo $rowSM['jam_selesai'] ;}else{echo $rowd['j_selesai'];} ?></td>
      <td><?php if($rowd['langganan']=="" AND substr($rowd['proses'],0,10)!="Cuci Mesin"){ echo $rowSM['menitSM'];}else if($rowd['lama_stop_menit'] !=""){$jam=floor(round($rowd['lama_stop_menit'])/60);$menit=round($rowd['lama_stop_menit'])%60; echo $jam.":".$menit;}?></td>
      <td><?php if($rowd['langganan']=="" AND substr($rowd['proses'],0,10)!="Cuci Mesin"){echo $rowSM['kd_stopmc'];} else{echo $rowd['kd_stop'];}?></td>
      ...
      <td><?php if($rowd['air_akhir']!=""){echo $rowd['air_akhir']-$rowd['air_awal'];}else{}?></td>
      <td><?php echo $rowd['target'];?></td>
      <td><?php echo $rowd['gerobak'];?></td>
      <td><?php echo $rowd['jns_gerobak'];?></td>
      <td>'<?php echo $rowd['loterp'];?></td>
      <td>'<?php echo $rowd['demanderp'];?></td>
