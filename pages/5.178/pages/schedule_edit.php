            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="?p=edit_schedule" enctype="multipart/form-data">
              ...
              <div class="modal-body">
				  ...
				  <input name="no_resep" type="text" class="form-control" id="no_resep" 
                    value="<?php echo $r['no_resep'];?>" placeholder="">				  	  
                  </div>
                  </div>
				  <div class="form-group">
				  ...
				  <input name="no_resep2" type="text" class="form-control" id="no_resep2" 
                    value="<?php echo $r['no_resep2'];?>" placeholder="">				  	  
                  </div>
                  </div>
				  <div class="form-group">
                  ...
                  <select name="ket_kain" class="form-control" onChange="aktifmesin();" id="ket_kain">
							  <option value="">Pilih</option>
							  <option value="Sudah Buka Kain" <?php if($r['ket_kain']=="Sudah Buka Kain"){echo "SELECTED";} ?>>Sudah Buka Kain</option>
							  <option value="Belum Buka Kain" <?php if($r['ket_kain']=="Belum Buka Kain"){echo "SELECTED";} ?>>Belum Buka Kain</option>
							  <option value="Kain Basah" <?php if($r['ket_kain']=="Kain Basah"){echo "SELECTED";} ?>>Kain Basah</option>
							  <option value="Kain Kering" <?php if($r['ket_kain']=="Kain Kering"){echo "SELECTED";} ?>>Kain Kering</option>	  
							  <option value="Sudah Jahit Pinggir <?php if($r['ket_kain']=="Sudah Jahit Pinggir"){echo "SELECTED";} ?>">Sudah Jahit Pinggir</option>
							  <option value="Pindah Dari Mesin" <?php if($r['ket_kain']=="Pindah Dari Mesin"){echo "SELECTED";} ?>>Pindah Dari Mesin</option>
							  <option value="Kain Sudah Priset" <?php if($r['ket_kain']=="Kain Sudah Priset"){echo "SELECTED";} ?>>Kain Sudah Priset</option>
					  		  <option value="Urgent" <?php if($r['ket_kain']=="Urgent"){echo "SELECTED";} ?>>Urgent</option>
					  		  <option value="Test Kestabilan" <?php if($r['ket_kain']=="Test Kestabilan"){echo "SELECTED";} ?>>Test Kestabilan</option>
				  </select>
                  <span class="help-block with-errors"></span>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-5">					  
						  <select name="ket" class="form-control" id="ket">
							  	<option value="">Pilih</option>
							    <option value='Cuci YD' <?php if($r['ket_status']=="Cuci YD"){echo "SELECTED";} ?>>Cuci YD</option>
							    <option value='Cuci Misty' <?php if($r['ket_status']=="Cuci Misty"){echo "SELECTED";} ?>>Cuci Misty</option>
							    <option value='Development Sample' <?php if($r['ket_status']=="Development Sample"){echo "SELECTED";} ?>>Development Sample</option>
							    <option value='First Lot' <?php if($r['ket_status']=="First Lot"){echo "SELECTED";} ?>>First Lot</option>
							    <option value='Gagal Proses' <?php if($r['ket_status']=="Cuci YD"){echo "SELECTED";} ?>>Gagal Proses</option>
							    <option value='Greige' <?php if($r['ket_status']=="Greige"){echo "SELECTED";} ?>>Greige</option>
							    <option value='Greige Delay' <?php if($r['ket_status']=="Greige Delay"){echo "SELECTED";} ?>>Greige Delay</option>
							    <option value='Mini Bulk' <?php if($r['ket_status']=="Mini Bulk"){echo "SELECTED";} ?>>Mini Bulk</option>
							    <option value='Perbaikan' <?php if($r['ket_status']=="Perbaikan"){echo "SELECTED";} ?>>Perbaikan</option>
							    <option value='Salesmen Sample' <?php if($r['ket_status']=="Salesmen Sample"){echo "SELECTED";} ?>>Salesmen Sample</option>
							    <option value='Relaxing-Preset' <?php if($r['ket_status']=="Relaxing-Preset"){echo "SELECTED";} ?>>Relaxing-Preset</option>
							    <option value='Scouring-Preset' <?php if($r['ket_status']=="Scouring-Preset"){echo "SELECTED";} ?>>Scouring-Preset</option>							    
							    <option value='Tolak Basah' <?php if($r['ket_status']=="Tolak Basah"){echo "SELECTED";} ?>>Tolak Basah</option>
			          </select>
				  </div>
		</div>
				  <div class="form-group">
                  ...
                  <span class="help-block with-errors"></span>
				  	...
				  	<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="checkbox" name="kk_kestabilan" id="kk_kestabilan" value="1" onclick="aktif2();" <?php if($r['kk_kestabilan']=="1"){ echo "checked";} ?> >  
							<label> KK Kestabilan</label>
						</div>
						<div class="col-sm-3">
							<input type="checkbox" name="kk_normal" id="kk_normal" onclick="aktif3();" value="1" <?php if($r['kk_normal']=="1"){ echo "checked";} ?> >  
                  ...
                  <select name="status" class="form-control">
							  	<option value="">Pilih</option>
					  			<option value="antri mesin" <?php if($r['status']=="antri mesin"){ echo "SELECTED";} ?>>Stop</option>
					  			<option value="selesai" <?php if($r['status']=="selesai"){ echo "SELECTED";} ?>>Start</option>
					  </select>
                  <span class="help-block with-errors"></span>
                  </div>
                  </div>
