						...
						<tbody>
							...
							<tr>
								...
								<td align="center" bgcolor="#E0DDDD">
									<span class="detail_status btn btn-sm <?php echo NoMesin("1475"); ?>" id="1475" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("1475"); ?>">1475
										<p><?php echo Waktu("1475"); ?></p>
									</span>
								</td>
							...
							<tr>
								...
								<td align="center" bgcolor="#ECE7E7"> 
									<span class="detail_status btn btn-sm <?php echo NoMesin("2639"); ?>" id="2639" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("2639"); ?>">2639
							...
							<tr>
								...
								<td bgcolor="#ECE7E7">&nbsp;</td>
								<td align="center" bgcolor="#E0DDDD"> 
									<span class="detail_status btn btn-sm <?php echo NoMesin("2636"); ?>" id="2636" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("2636"); ?>">2636
										<p><?php echo Waktu("2636"); ?></p>
									</span> 
								</td>
								<td align="center" bgcolor="#E0DDDD"> 
									<span class="detail_status btn btn-sm <?php echo NoMesin("2247"); ?>" id="2247" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("2247"); ?>">2247
								...
								<td align="center" bgcolor="#ECE7E7">&nbsp;</td>
								<td align="center" bgcolor="#E0DDDD">
									<span class="detail_status btn  btn-sm <?php echo NoMesin("1115"); ?>" id="1115" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("1115"); ?>">1115
										<p><?php echo Waktu("1115"); ?></p>
									</span>
								</td>
								<td colspan="2" align="center" bgcolor="#E0DDDD">
									<span class="detail_status btn  btn-sm <?php echo NoMesin("1474"); ?>" id="1474" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("1474"); ?>">1474
										<p><?php echo Waktu("1474"); ?></p>
									</span>
								</td>
								<td align="center" bgcolor="#ECE7E7">&nbsp;</td>
								<td colspan="2" align="center" bgcolor="#E0DDDD">&nbsp;</td>
								...
								<td align="center" bgcolor="#ECE7E7">&nbsp;</td>
								<td align="center" bgcolor="#E0DDDD">
									<span class="detail_status btn btn-sm <?php echo NoMesin("1458"); ?>" id="1458" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("1458"); ?>">1458
										<p><?php echo Waktu("1458"); ?></p>
									</span>
								</td>
								<td align="center" bgcolor="#E0DDDD">
									<span class="detail_status btn btn-sm <?php echo NoMesin("2623"); ?>" id="2623" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("2623"); ?>">2623
										<p><?php echo Waktu("2623"); ?></p>
									</span>
								</td>
								<td align="center" bgcolor="#ECE7E7"> 
									<span class="detail_status btn btn-sm <?php echo NoMesin("1454"); ?>" id="1454" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("1454"); ?>">1454
								...
								<td align="center" bgcolor="#ECE7E7">
									<span class="detail_status btn btn-sm <?php echo NoMesin("2635"); ?>" id="2635" data-toggle="tooltip" data-html="true" title="<?php echo Rajut("2635"); ?>">2635
							...
							<tr>
								...
								<td colspan="4">
									<font size="-1">Development Sample</font> <span class="label bg-fuchsia"> &nbsp;<?php echo $totDTS; ?></span>
								</td>
							...
							<tr>
								...
								<td>&nbsp;</td>
								<td colspan="6">
									<font size="-2">Cont/Scour/Relax-Preset</font> <span class="label btn-sm bg-purple">&nbsp;<?php echo $totSPT; ?></span>
								</td>
								<td colspan="4">
									<font size="-2">Salesmen Sample-1st Lot</font> <span class="label bg-lime">&nbsp;<?php echo $totSMS; ?></span>
								</td>
