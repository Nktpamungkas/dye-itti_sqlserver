...
<body>
<?php
   $data=mysqli_query($con,"SELECT * FROM tbl_setting_mesin 
ORDER BY
	id ASC");
	$no=1;
	$n=1;
...
<table id="example1" class="table table-bordered table-hover table-striped" width="100%">
          <thead class="bg-blue">
            <tr>
			  ...
			  <th width="26" rowspan="2"><div align="center">Tgl Celup</div></th>
              ...
              <th width="15" rowspan="2"><div align="center">Kapasitas</div></th>
              <th width="15" rowspan="2"><div align="center">Acuan Qty</div></th>
			  ...
			  <th width="20" rowspan="2"><div align="center">Qty</div></th>
			  <th width="20" rowspan="2"><div align="center">Panjang Kain</div></th>
			  ...
			  <th width="40" colspan="2"><div align="center">No Program</div></th>
			  ...
			  <th width="30" rowspan="2"><div align="center">Keterangan</div></th>
			  <th width="20" rowspan="2"><div align="center">Jumlah Test</div></th>
			  <th width="20" rowspan="2"><div align="center">Update Status</div></th>
			  <th width="50" colspan="2"><div align="center">NCP</div></th>
            </tr>
			<tr>
				...
				<th width="10"><div align="center">No NCP</div></th>
			</tr>
          </thead>
          <tbody>
            <?php
  ...
  while($rowd=mysqli_fetch_array($data)){
	  	...
	  	$qNCP=mysqli_query($cond,"SELECT masalah, no_ncp FROM tbl_ncp_qcf_new WHERE nokk='$rowd[nokk]'");
	  	$rNCP=mysqli_fetch_array($qNCP);
		 ?>
