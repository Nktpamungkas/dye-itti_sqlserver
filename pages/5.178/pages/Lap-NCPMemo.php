...
<div class="box box-success ">
 ...
 <div class="col-xs-5">	
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped" style="width: 100%;">
          <thead class="bg-blue">
            <tr>
              <th width="15%"><div align="center">Masalah DYE</div></th>
	...
	$WKategori=" ncp_hitung='tidak' AND ";	
            ...
            $totaldDis=0;
            $totaldllDis=0;
            $qryAll=mysqli_query($cond,"SELECT COUNT(*) AS jml_all, if(SUM(berat) is null,0,SUM(berat)) AS berat_all FROM tbl_ncp_qcf_new WHERE $WKategori DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND (masalah_dominan!='' OR masalah_dominan!=NULL) AND NOT status='Cancel'");
            $rAll=mysqli_fetch_array($qryAll);
            $qryAllDis=mysqli_query($cond,"SELECT COUNT(*) AS jml_all, if(SUM(berat) is null,0,SUM(berat)) AS berat_all FROM tbl_ncp_qcf_new WHERE $WKategori DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND (masalah_dominan!='' OR masalah_dominan!=NULL) AND `status`='Disposisi' AND NOT status='Cancel' ");
            $rAllDis=mysqli_fetch_array($qryAllDis);
            $qrydef=mysqli_query($cond,"SELECT SUM(berat) AS berat, ROUND(COUNT(masalah_dominan)/(SELECT COUNT(*) FROM tbl_ncp_qcf_new WHERE $WKategori DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND NOT status='Cancel'
            ...
            while($rd=mysqli_fetch_array($qrydef)){
              $qrydefDis=mysqli_query($cond,"SELECT SUM(berat) AS berat, ROUND(COUNT(masalah_dominan)/(SELECT COUNT(*) FROM tbl_ncp_qcf_new WHERE $WKategori DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND `status`='Disposisi' AND masalah_dominan='$rd[masalah_dominan]' AND NOT status='Cancel'
    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped" style="width: 100%;">
          <thead class="bg-blue">
            <tr>
              <th width="15%"><div align="center">Mesin</div></th>
              <th width="10%"><div align="center">KG</div></th>
              <th width="5%"><div align="center">%</div></th>
              <th width="10%"><div align="center">Disposisi</div></th>
              <th width="5%"><div align="center">% Disp.</div></th>
          ...
          <tbody>
            ...
            $totaldptDis=0;
            $totaldlldptDis=0;
            $qryAllDpt=mysqli_query($cond,"SELECT COUNT(*) AS jml_all, if(SUM(berat) is null,0,SUM(berat)) AS berat_all FROM tbl_ncp_qcf_new WHERE $WKategori DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND (nama_mesin!='' OR nama_mesin!=NULL) AND NOT status='Cancel' AND dept='DYE' ");
            $rAllDpt=mysqli_fetch_array($qryAllDpt);
            $qryAllDptDis=mysqli_query($cond,"SELECT COUNT(*) AS jml_all, if(SUM(berat) is null,0,SUM(berat)) AS berat_all FROM tbl_ncp_qcf_new WHERE $WKategori DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND (nama_mesin!='' OR nama_mesin!=NULL) AND `status`='Disposisi' AND NOT status='Cancel'  AND dept='DYE'");
            $rAllDptDis=mysqli_fetch_array($qryAllDptDis);
            $qrydpt=mysqli_query($cond,"SELECT SUM(berat) AS berat, ROUND(COUNT(nama_mesin)/(SELECT COUNT(*) FROM tbl_ncp_qcf_new WHERE $WKategori DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND NOT status='Cancel' AND dept='DYE'
            ...
            while($rdpt=mysqli_fetch_array($qrydpt)){
              $qrydptDis=mysqli_query($cond,"SELECT SUM(berat) AS berat, ROUND(COUNT(nama_mesin)/(SELECT COUNT(*) FROM tbl_ncp_qcf_new WHERE $WKategori DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND `status`='Disposisi' AND dept='DYE' AND NOT status='Cancel'
              AND (nama_mesin!='' OR nama_mesin!=NULL))*100,1) AS persen,
              nama_mesin
              FROM
              `tbl_ncp_qcf_new`
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
        <thead class="bg-green">
          <tr>
            <th><div align="center">Status NCP</div></th>
            <th><div align="center">No NCP</div></th>
            <th><div align="center">KK NCP</div></th>
            ...
            <th><div align="center">KK Induk</div></th>
            <th><div align="center">Rol Induk</div></th>
            <th><div align="center">Rol NCP</div></th>
            <th><div align="center">Qty NCP</div></th>
            <th><div align="center">Tolak QCF</div></th>
            <th><div align="center">Tgl CLP</div></th>
            <th><div align="center">Mesin CLP</div></th>
            <th><div align="center">Nama Mesin</div></th>
            <th><div align="center">ACC Keluar Kain</div></th>
            <th align="center" class="table-list1"><div align="center">Operator</div></th>
            <th align="center" class="table-list1"><div align="center">Keterangan Masalah</div></th>
            <th align="center" class="table-list1"><div align="center">Tempat Kain</div></th>
            <th align="center" class="table-list1"><div align="center">Tgl Penyelesaian</div></th>
            <th align="center" class="table-list1"><div align="center">Acc Perbaikan</div></th>
	...
	while($row1=mysqli_fetch_array($qry1)){
		$qCekNCP=mysqli_query($cond,"SELECT * FROM tbl_ncp_qcf_new WHERE nokk='$row1[nokk_ncp]' and no_ncp_gabungan='$row1[no_ncp]' and dept='DYE' ORDER BY id DESC");
