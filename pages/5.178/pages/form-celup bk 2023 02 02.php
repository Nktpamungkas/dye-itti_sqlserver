	...
	<div class="box box-info">
		...
		<div class="box-body">
			<div class="col-md-6">
				...
				<div class="form-group">
					<label for="target" class="col-sm-3 control-label">Target Waktu</label>
					<div class="col-sm-3">
						<input name="target" type="text" class="form-control" id="target" value="<?= $rcek['target']; ?>">
					</div>
				</div>
			</div>
			<!-- col -->
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select name="k_resep" class="form-control" id="k_resep" onChange="aktif5();" required>
							<option value="">Pilih</option>
							<option value="-">-</option>
