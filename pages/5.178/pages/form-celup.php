		...
		<div class="box-body">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="demand" type="text" class="form-control" id="demand" value="<?php if ($cek > 0) {
																											echo $rcek['nodemand'];
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php
    						$_noprod    = substr($rRcode['no_resep'], 0,8);
    						$_groupline	= substr($rRcode['no_resep'], 9);
						...
						?>
						<input name="rcode1" type="text" class="form-control" id="rcode1" value="<?= $dt_rcode['RCODE']; ?>">
					</div>
				</div>
				<div class="form-group">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input name="no_resep" type="text" class="form-control" id="no_resep" value="<?php if ($rcek['no_resep'] != "") {
																											echo $rcek['no_resep'];
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input name="no_resep2" type="text" class="form-control" id="no_resep2" value="<?php if ($rcek['no_resep2'] != "") {
																											echo $rcek['no_resep2'];
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="resep" class="form-control" id="resep" required>
							<option value="">Pilih</option>
							<option value="Baru" <?php if ($rcek['resep'] == 'Baru') {
														echo "SELECTED";
													} ?>>Baru</option>
							<option value="Lama" <?php if ($rcek['resep'] == 'lama') {
														echo "SELECTED";
													} ?>>Lama</option>
						</select>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="kategori_warna" class="form-control" id="kategori_warna">
							<option value="">Pilih</option>
							<option value="Light" <?php if ($rcek['kategori_warna'] == 'Light') {
														echo "SELECTED";
													} ?>>Light</option>
							<option value="Medium" <?php if ($rcek['kategori_warna'] == 'Medium') {
														echo "SELECTED";
													} ?>>Medium</option>
							<option value="Dark" <?php if ($rcek['kategori_warna'] == 'Dark') {
														echo "SELECTED";
													} ?>>Dark</option>
							<option value="White" <?php if ($rcek['kategori_warna'] == 'White') {
														echo "SELECTED";
													} ?>>White</option>
						</select>
					</div>
