      ...
      <table class="table table-bordered table-hover table-striped" id="example3">
        <thead class="bg-blue">
          <tr>
            ...
            <th><div align="center">Kap</div></th>
            ...
            <th><div align="center">Tgl In</div></th>
            <th><div>
	...
	a.kapasitas DESC, a.no_mesin ASC");
		 ...
		 ?>
          <tr bgcolor="<?php echo $bgcolor; ?>">
            <td align="center"><font size="-1"><?php echo $no; ?></td>
            <td align="center"><font size="-1"><?php echo $row1['kapasitas'];?></td>
            <td align="center"><font size="-1"><?php echo $row1['no_mesin'];?></td>
            <td align="center"><font size="-1"><?php if($dt['g_shift']!=""){echo $dt['g_shift'];}else{echo $row1['g_shift']; }?></td>
            <td align="center" bgcolor="<?php if($row1['ket']=="Over" and $dt['g_shift']==""){ echo "#FD5B5B";}else if($row1['ket']=="OK" and $dt['g_shift']==""){echo "#14EF78";} ?>"><font size="-1"><?php if($dt['g_shift']!=""){echo $dt['operator'];}else{echo $row1['operator']; }?></td>
            <td><font size="-1"><?php if($dt['g_shift']!=""){echo $dt['jenis_kain'];}else{echo $row1['jenis_kain']; }?></font></td>
            ...
            <td align="center"><font size="-1"><?php if($dt['g_shift']!=""){echo $dt['proses'];}else{echo $row1['proses']; }?></td>
            <td align="center"><font size="-1"><?php if($dt['g_shift']!=""){echo $dt['kategori_warna'];}else{echo $row1['kategori_warna']; }?></td>
            <td align="center"><font size="-1"><?php if($dt['g_shift']!=""){echo $dt['target'];}else{echo $row1['target']; }?></td>
            <td align="center" bgcolor="<?php if($row1['ket']=="Over" and $dt['g_shift']==""){ echo "#FD5B5B";}else if($row1['ket']=="OK" and $dt['g_shift']==""){echo "#14EF78";} ?>"><font size="-1"><?php if($dt['g_shift']!=""){echo $dt['target'];}else{echo $row1['tgl_in']; }?></td>
            <td align="center" bgcolor="<?php if($row1['ket']=="Over" and $dt['g_shift']==""){ echo "#FD5B5B";}else if($row1['ket']=="OK" and $dt['g_shift']==""){echo "#14EF78";} ?>"><font size="-1"><?php if($dt['g_shift']!=""){echo $dt['target'];}else{echo $row1['tgl_out']; }?></td>
            <td align="center" bgcolor="<?php if($row1['ket']=="Over" and $dt['g_shift']==""){ echo "#FD5B5B";}else if($row1['ket']=="OK" and $dt['g_shift']==""){echo "#14EF78";} ?>"><font size="-1"><?php if($dt['g_shift']!=""){echo $dt['lama'];}else{echo $row1['lama']; }?></td>
            <td align="center"><font size="-1"><?php if($dt['g_shift']==""){echo $row1['k_resep'];}?></td>
            <td align="center"><font size="-1"><?php if($dt['g_shift']==""){echo $row1['point'];}?></td>
            <td align="center"><font size="-1"><?php if($row1['ket']=="Over" and $dt['g_shift']==""){ echo "Tidak Tercapai";}else if($row1['ket']=="OK" and $dt['g_shift']==""){echo "Tercapai";} ?></td>
          </tr>
          <?php	$no++;  } ?>
        </tbody>
      </table>
