...
if($resep!=''){$ket.=" AND ID_NO='$resep' ";}else{$ket.="";}
...
$sqlRcode=mysql_query("SELECT no_resep FROM tbl_schedule WHERE nokk='$nokk' ORDER BY id DESC LIMIT 1");
$rRcode=mysql_fetch_array($sqlRcode);
$sqlTopping=mysql_query("SELECT jml_topping FROM tbl_hasilcelup WHERE nokk='$nokk' ORDER BY id DESC LIMIT 1");
$rTopping=mysql_fetch_array($sqlTopping);
?>
<?php
 	...
 	<div class="box-body"> 
	  <div class="col-md-6">
		...
		<div class="form-group">
          ...
          <div class="col-sm-3">
                    <input name="rcode1" type="text" class="form-control" id="rcode1" 
                    value="<?php echo trim(rcode($nokk,$rRcode[no_resep])); ?>">
                  </div>				   
        </div>  
	  </div>
	  		<!-- col --> 
		...
		<div class="form-group">
				 ...
				 <div class="col-sm-3">					  
						  <select name="jml_topping" class="form-control" id="jml_topping" required disabled="disabled">
							    ...
							    <option value="-">-</option>
							  	<option value="0x" <?php if($rTopping[jml_topping]=="0x"){ echo "SELECTED";}?>>0x</option>				
							  	<option value="1x" <?php if($rTopping[jml_topping]=="1x"){ echo "SELECTED";}?>>1x</option>
							    <option value="2x" <?php if($rTopping[jml_topping]=="2x"){ echo "SELECTED";}?>>2x</option>
							  	<option value="3x" <?php if($rTopping[jml_topping]=="3x"){ echo "SELECTED";}?>>3x</option>
							    <option value="4x" <?php if($rTopping[jml_topping]=="4x"){ echo "SELECTED";}?>>4x</option>
							  	<option value="5x" <?php if($rTopping[jml_topping]=="5x"){ echo "SELECTED";}?>>5x</option>
							  	<option value="6x" <?php if($rTopping[jml_topping]=="6x"){ echo "SELECTED";}?>>6x</option>
							    <option value="7x" <?php if($rTopping[jml_topping]=="7x"){ echo "SELECTED";}?>>7x</option>
							  	<option value="8x" <?php if($rTopping[jml_topping]=="8x"){ echo "SELECTED";}?>>8x</option>
							    <option value="9x" <?php if($rTopping[jml_topping]=="9x"){ echo "SELECTED";}?>>9x</option>
							  	<option value="10x" <?php if($rTopping[jml_topping]=="10x"){ echo "SELECTED";}?>>10x</option>
					  </select>
				  </div>	
