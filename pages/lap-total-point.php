				...
				<div class="box-body">
					...
					function Point($mc, $GShift1, $start_date1, $stop_date1)
					{
						...
						if ($GShift1 == "ALL") {
							...
							$shft = " COALESCE(a.g_shift, b.g_shift, c.g_shift) = '$GShift1' AND ";
						}
						if ($Awal != "" and $Akhir != "") {
							$Where = " CONVERT(datetime, c.tgl_update) BETWEEN '$start_date1' AND '$stop_date1' AND ";
						} else {
							$Where = null;
						}
						$qMC = sqlsrv_query($con, "SELECT    
