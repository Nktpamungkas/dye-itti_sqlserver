...
$sqlCekWaktu = sqlsrv_query($con, "	SELECT TOP
										1 th.operator_keluar,
...
$sqlCek1 = sqlsrv_query($con, "	SELECT TOP
									1 * 
								FROM
...
$sqlvDB2 = "SELECT
			...
			FROM
				...
				ON ITXVIEW_RESERVATION.PRODUCTIONORDERCODE = VIEWPRODUCTIONRESERVATION.PRODUCTIONORDERCODE 
		...
		<div class="box-body">
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input name="nokk" type="text" class="form-control" id="nokk" onchange="window.location='?p=Form-Setting-Mesin&nokk='+this.value" value="<?php echo $_GET['nokk']; ?>" placeholder="No KK" required>
					</div>
				</div>
				<div class="form-group">
					<label for="langganan" class="col-sm-3 control-label">Langganan</label>
					<div class="col-sm-8">
						<input name="langganan" type="text" class="form-control" id="langganan" value="<?php if ($cek1 > 0) {
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="buyer" type="text" class="form-control" id="buyer" value="<?php if ($cek1 > 0) {
																									echo $rcek1['buyer'];
																								} else {
																									echo $buyer;
																								} ?>" placeholder="Buyer">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input name="po" type="text" class="form-control" id="po" value="<?php if ($cek1 > 0) {
																								echo $rcek1['po'];
																							} else {
																								if ($r['PONumber'] != "") {
																									echo $r['PONumber'];
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group date">
							...
							<input name="tgl_delivery" type="text" class="form-control pull-right" id="datepicker2" placeholder="0000-00-00" value="<?php if ($cek1 > 0) {
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input name="lebar" type="number" class="form-control" id="lebar" value="<?php if ($cek1 > 0) {
																										echo $rcek1['lebar'];
																									} else {
																										echo round($r['Lebar']);
					...
					<div class="col-sm-2">
						<input name="grms" type="number" class="form-control" id="grms" value="<?php if ($cek1 > 0) {
																									echo $rcek1['gramasi'];
																								} else {
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="warna" type="text" class="form-control" id="warna" value="<?php if ($cek1 > 0) {
																									echo $rcek1['warna'];
																								} else {
																									if ($r['Color'] != "") {
																										echo $r['Color'];
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input name="no_warna" type="text" class="form-control" id="no_warna" value="<?php if ($cek1 > 0) {
																											echo $rcek1['no_warna'];
																										} else {
																											if ($r['ColorNo'] != "") {
																												echo $r['ColorNo'];
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input name="qty1" type="number" class="form-control" id="qty1" value="<?php if ($cek1 > 0) {
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input name="qty2" type="number" class="form-control" id="qty2" value="<?php if ($cek1 > 0) {
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input name="qty3" type="number" min="0" class="form-control" id="qty3" value="<?php if ($cek1 > 0) {
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input name="qty4" type="number" min="0" class="form-control" id="qty4" value="<?php if ($cek1 > 0) {
																												echo $rcek1['bruto'];
																											} else {
																												if ($r['Weight'] != "") {
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input name="pjng_kain" type="text" class="form-control" id="pjng_kain" value="<?php if ($cek1 > 0) {
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input name="loading" type="number" min="0" step=".01" style="text-align: right;" class="form-control" id="loading" value="<?php if ($_GET['nokk'] != "" and $rcek1['kapasitas'] != "") {
																																							echo $loading;
																																						} ?>" placeholder="0.00">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input name="prod_order" type="text" class="form-control" id="prod_order" value="<?php if ($cek > 0) {
																												echo $rcek1['prod_order'];
																											} ?>" placeholder="Production Order" required>
					</div>
					<div class="col-sm-4">
						<input name="prod_demand" type="text" class="form-control" id="prod_demand" value="<?php if ($cek > 0) {
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input name="l_r_poly" type="text" class="form-control" id="l_r_poly" value="<?php if ($nokk != "") {
																											echo "1:" . $lr;
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input name="cycle_time" type="number" min="0" class="form-control" id="cycle_time" value="" placeholder="0" style="text-align: right;">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input name="rpm" type="number" class="form-control" min="0" id="rpm" value="" placeholder="0" style="text-align: right;">
					</div>
				</div>
				<div class="form-group">
					<label for="tekanan" class="col-sm-3 control-label">Tekanan Cotton</label>
					<div class="col-sm-2">
						<input name="tekanan" type="number" class="form-control" min="0" step=".01" id="tekanan" value="" placeholder="0" style="text-align: right;">
					</div>
					<label for="tekanan_poly" class="col-sm-3 control-label">Tekanan Poly</label>
					<div class="col-sm-2">
						<input name="tekanan_poly" type="number" class="form-control" min="0" step=".01" id="tekanan_poly" value="" placeholder="0" style="text-align: right;">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input name="blower" type="number" min="0" step=".01" class="form-control" id="blower" value="" placeholder="0" style="text-align: right;" required>
							<span class="input-group-addon">%</span>
						</div>
					</div>
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input name="blower_poly" type="number" min="0" step=".01" class="form-control" id="blower_poly" value="" placeholder="0" style="text-align: right;" required>
							<span class="input-group-addon">%</span>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="file" id="file_gambar" name="file_gambar"><span style="color:red;"><?php if ($rcek1['file_gambar'] != "") {
...
if ($_POST['save'] == "save") {
	...
	$sqlData = sqlsrv_query($con, "INSERT INTO db_dying.tbl_setting_mesin (
        nokk, langganan, buyer, no_order, po, no_hanger, no_item, jenis_kain,
        tgl_delivery, lebar, gramasi, warna, no_warna, qty_order, pnjg_order,
        satuan_order, lot, rol, bruto, pjng_kain, kapasitas, no_mc, loading,
        prod_order, prod_demand, no_program, l_r, l_r_poly, cycle_time,
        masukkain, rpm, tekanan, tekanan_poly, nozzle, nozzle_poly, blower,
        blower_poly, plaiter, jumlah_test, catatan, alur_proses, file_gambar,
        tgl_buat, tgl_update
    )
    VALUES (
        '$_POST[nokk]', '$_POST[langganan]', '$_POST[buyer]', '$_POST[no_order]', '$po',
        '$_POST[no_hanger]', '$_POST[no_item]', '$_POST[jns_kain]', '$_POST[tgl_delivery]',
        '$_POST[lebar]', '$_POST[grms]', '$_POST[warna]', '$_POST[no_warna]', '$_POST[qty1]',
        '$_POST[qty2]', '$_POST[satuan1]', '$_POST[lot]', '$_POST[qty3]', '$_POST[qty4]',
        '$_POST[pjng_kain]', '$_POST[kapasitas]', '$_POST[no_mc]', '$_POST[loading]',
        '$_POST[prod_order]', '$_POST[prod_demand]', '$_POST[no_program]', '$_POST[l_r]',
        '$_POST[l_r_poly]', '$_POST[cycle_time]', '$_POST[masukkain]', '$_POST[rpm]',
        '$_POST[tekanan]', '$_POST[tekanan_poly]', '$_POST[nozzle]', '$_POST[nozzle_poly]',
        '$_POST[blower]', '$_POST[blower_poly]', '$_POST[plaiter]', '$_POST[jumlah_test]',
        '$catatan', '$alur_proses', '$file_gambar', GETDATE(), GETDATE()
    )");
