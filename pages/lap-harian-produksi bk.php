  ...
  <form method="post" enctype="multipart/form-data" name="form1" class="form-horizontal" id="form1">
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-2">
				  <div class="input-group">
                    <input type="text" class="form-control timepicker" name="jam_akhir" placeholder="00:00" value="<?php echo $jamAr;?>">
                    <div class="input-group-addon">
                      <i class="fa fa-clock-o"></i>
                   </div>
                  </div>
...
WHERE
	$shft
	$Where
	) x ON a.no_mesin=x.no_mesin $Where1 ORDER BY a.no_mesin ");	
