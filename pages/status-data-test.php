					...
					<table id="example1" class="table table-bordered table-hover table-striped" width="100%">
						<thead class="bg-blue">
							<tr>
								...
								<th width="30" rowspan="2">
									<div align="center">No Prod. Order</div>
								</th>
								<th width="30" rowspan="2">
								...
								<th width="40" rowspan="2">
									<div align="center">Grafik</div>
								</th>
								<th width="30" rowspan="2">
									<div align="center">Keterangan Proses</div>
								</th>
								<th width="20" rowspan="2">
									<div align="center">Hasil QC</div>
								</th>
								<th width="20" rowspan="2">
									<div align="center">Cek Shading</div>
								</th>
								<th width="20" rowspan="2">
									<div align="center">Inspect Report</div>
								</th>
								<th width="20" rowspan="2">
						...
						<tbody>
							...
							while ($rowd = sqlsrv_fetch_array($data)) {
								...
								$rMT = sqlsrv_fetch_array($qMT);
							?>
								<tr bgcolor="<?php echo $bgcolor; ?>">
									<td align="center"><?php echo cek($rowd['tgl_buat'], "d/m/y"); ?></td>
									...
									<td align="center"><?php echo cek($rMT['tgl_buat'],"d/m/y"); ?></td>
