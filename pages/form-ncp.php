...
$sqlCek3=mysqli_query($con,"SELECT * FROM tbl_montemp WHERE id='$rcek1[idm]' and (status='antri mesin' or status='sedang jalan' or status='selesai') ORDER BY id DESC LIMIT 1");
...
$sqlCek4=mysqli_query($con,"SELECT * FROM tbl_montemp WHERE id='$rcek1[idm]' ORDER BY id DESC LIMIT 1");
$cek4=mysqli_num_rows($sqlCek4);
$rcek4=mysqli_fetch_array($sqlCek4);
$sqlNCP=mysqli_query($cond,"SELECT * FROM tbl_ncp_qcf_now WHERE (nokk='$nokkNCP' or nokk_salinan='$nokkNCP') and dept='DYE' ORDER BY id DESC LIMIT 1");
$cekNCP=mysqli_fetch_array($sqlNCP);
$sqlNCP1=mysqli_query($cond,"SELECT * FROM tbl_ncp_qcf_now WHERE (nokk='$nokk' or nokk_salinan='$nokk') and dept='DYE' ORDER BY id DESC LIMIT 1");
...
$tgl_celup = mysqli_query($con, "SELECT * FROM tbl_montemp WHERE nokk='00102495' AND tgl_buat < '$cekNCP[tgl_buat]' ORDER BY id DESC LIMIT 1");
$row_tgl_celup	= mysqli_fetch_assoc($tgl_celup);
		...
		<div class="form-group">
					...
					<div class="col-sm-2">
						<select name="k_resep" class="form-control" id="k_resep" required>
							...
							<option value="-">-</option>
							<option value="0x" <?php if($rcek1['k_resep']=='0x'){echo "SELECTED";}?>>0x</option>
							<option value="1x" <?php if($rcek1['k_resep']=='1x'){echo "SELECTED";}?>>1x</option>
							<option value="2x" <?php if($rcek1['k_resep']=='2x'){echo "SELECTED";}?>>2x</option>
							<option value="3x" <?php if($rcek1['k_resep']=='3x'){echo "SELECTED";}?>>3x</option>
							<option value="4x" <?php if($rcek1['k_resep']=='4x'){echo "SELECTED";}?>>4x</option>
							<option value="5x" <?php if($rcek1['k_resep']=='5x'){echo "SELECTED";}?>>5x</option>
							<option value="6x" <?php if($rcek1['k_resep']=='6x'){echo "SELECTED";}?>>6x</option>
							<option value="7x" <?php if($rcek1['k_resep']=='7x'){echo "SELECTED";}?>>7x</option>
							<option value="8x" <?php if($rcek1['k_resep']=='8x'){echo "SELECTED";}?>>8x</option>
							<option value="9x" <?php if($rcek1['k_resep']=='9x'){echo "SELECTED";}?>>9x</option>
							<option value="10x" <?php if($rcek1['k_resep']=='10x'){echo "SELECTED";}?>>10x</option>
							<option value=">10x" <?php if($rcek1['k_resep']=='>10x'){echo "SELECTED";}?>>>10x</option>
						</select>
					</div>
					...
					<div class="col-sm-2">
						<select name="kategori_resep" class="form-control" id="kategori_resep">
							<option value="">Pilih</option>
							<option value="Baru" <?php if($rcek1['resep']=='Baru'){echo "SELECTED";}?>>Baru</option>
							<option value="Lama" <?php if($rcek1['resep']=='lama'){echo "SELECTED";}?>>Lama</option>
						</select>
					</div>
	  ...
	  <div class="col-md-6">
		...
		<div class="form-group"> 
		  ...
		  <select class="form-control select2" name="no_ncp" id="no_ncp" > 
				...
				if($nokkNCP!=""){$Wncp=" (nokk='$_GET[nokkncp]' or nokk_salinan='$_GET[nokkncp]') and ";}else{
					...
					$qCek=mysqli_query($cond,"SELECT no_ncp_gabungan FROM tbl_ncp_qcf_now WHERE $Wncp dept='DYE' ORDER BY id DESC");
		...
		<div class="form-group">
          ...
          <div class="col-sm-5">
			...
			<span class="input-group-btn"><button type="button" class="btn btn-default" data-toggle="modal" data-target="#DataKategoriMasalah"> ...</button></span>	
			  ...
			  <div class="col-sm-2">
				<input name="lot_ncp" type="text" required class="form-control" id="lot_ncp" placeholder="" 
				value="<?php if($nokkNCP!=""){ echo $cekNCP['lot']; }?>" >
			  </div>				   
        </div>  
		<!--<div class="form-group">
		...
		<div class="form-group">
			  ...
			  <div class="col-sm-3">
				...
				value="<?php echo $row_tgl_celup['bruto']; ?>" >
		...
		<div class="form-group">
                  ...
                  <div class="col-sm-2">					  	  	
				   <input name="no_mc" id="no_mc" class="form-control"  value="<?php echo $rcek1['no_mesin']; ?>" <?php if($_GET['manual']!="ya"){echo "readonly";} ?>>
				  </div>
					<?php 
					$qMC=mysqli_query($con,"SELECT kode FROM tbl_mesin WHERE no_mesin='$rcek1[no_mesin]'");
		...
		<div class="form-group">
          ...
          <div class="col-sm-3">
                    <input name="press_pump" type="text" class="form-control" id="press_pump" value="<?php echo $row_tgl_celup['tekanan']; ?>" readonly="readonly">
                  </div>	
        </div>
		<div class="form-group">
          ...
          <div class="col-sm-3">
                    <input name="nozzle" type="text" class="form-control" id="nozzle" value="<?php echo $row_tgl_celup['nozzle']; ?>" readonly="readonly">
                  </div>	
        </div>  
		<div class="form-group">
          ...
          <div class="col-sm-3">
                    <input name="blower" type="text" class="form-control" id="blower" value="<?php echo $row_tgl_celup['blower']; ?>" readonly="readonly">
                  </div>	
        </div>
		<div class="form-group">
          <label for="rpm" class="col-sm-3 control-label">RPM</label>
          <div class="col-sm-3">
                    <input name="rpm" type="text" class="form-control" id="rpm" value="<?php echo $row_tgl_celup['rpm']; ?>" readonly="readonly">
                  </div>
		...
		<div class="form-group">		  	
          ...
          <div class="col-sm-3">
                    <input name="cycle_time" type="text" class="form-control" id="cycle_time" value="<?php echo $row_tgl_celup['cycle_time']; ?>" readonly="readonly">
                  </div>
...
//$ket=str_replace("'","''",$_POST['ket']); 
	...
	$sqlDataQC=mysqli_query($cond,"UPDATE tbl_ncp_qcf_now SET 
	      ncp_in_dye='1'
		  WHERE id='$_POST[id]'");	
