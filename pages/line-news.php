            ...
            <tbody>
              ...
              while ($rNews = sqlsrv_fetch_array($news)) {
                ...
                <tr align="center" bgcolor="<?php echo $bgcolor; ?>">
                  ...
                  <td align="center"><span class="label <?php if ($rNews['status'] == "Tampil") {
                                                          echo "label-success";
                                                        } else {
                                                          echo "label-warning";
                                                        } ?>"><?php echo $rNews['status']; ?></span></td>
                  <td align="center">
                    <?php echo cek($rNews['tgl_update']); ?>
                  </td>
                  <td align="center">
                    <div class="btn-group"><a href="#" id='<?php echo $rNews['id'] ?>' class="btn btn-xs btn-info news_edit"><i class="fa fa-edit"></i> </a><a href="#" onclick="confirm_del('?p=news_hapus&id=<?php echo $rNews['id'] ?>');" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i> </a></div>
                    </th>
                </tr>
              <?php
                $no++;
