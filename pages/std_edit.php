      ...
      <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="?p=edit_std" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input name="jenis" type="text" class="form-control" value="<?php echo $r['jenis']; ?>" required>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <div class="input-group">
                <input name="target" type="number" class="form-control" value="<?php echo $r['target']; ?>" style="text-align: right;" required placeholder="0">
