    ...
    <div class="box box-info">
        ...
        <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="nokk" type="text" class="form-control" id="nokk"
                            onchange="window.location='?p=Form-Matching-Dyeing&nokk='+this.value"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <select name="jenis_proses" class="form-control" required>
                            ...
                            <?php
                            $q_prosses = sqlsrv_query($con, "SELECT * FROM db_dying.tbl_jenis_proses ORDER BY id ASC");
                            ?>
                            <?php while ($row_prosses = sqlsrv_fetch_array($q_prosses)) { ?>
                            <option value="<?= $row_prosses['proses_name'] . "/" . $row_prosses['std_waktu']; ?>">
                                <?= $row_prosses['proses_name']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input name="jam_terima" type="datetime" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control select2" name="operator_penerima">
                            <option selected disabled value="-">Dipilih</option>
                            <?php
                            $q_staff = sqlsrv_query($con, "SELECT * FROM db_dying.tbl_staff WHERE jabatan = 'Operator'");
                            ?>
                            <?php while ($row_staff = sqlsrv_fetch_array($q_staff)) { ?>
                            <option value="<?= $row_staff['nama']; ?>"><?= $row_staff['nama']; ?></option>
                            <?php } ?>
        ...
        <div class="box-footer">
            <button type="button" class="btn btn-default pull-left" name="back" value="kembali"
                onClick="window.location='?p=Matching-Dyeing'">Kembali <i
...
if ($_POST['save'] == "save") {
    ...
    $query = "INSERT INTO db_dying.tbl_matching_dyeing 
          (nokk, nodemand, no_order, shift, gshift, langganan, jenis_kain, no_warna, warna, buyer, jam_terima, acc_matching, operator_penerima, keterangan, std_waktu_prosses, jenis_prosses, createdatetime)
          VALUES
          ('$_POST[nokk]', '$_POST[demand]', '$_POST[no_order]', '$_POST[shift]', '$_POST[g_shift]', '$_POST[langganan]', '$_POST[jns_kain]', '$_POST[no_warna]', '$_POST[warna]', '$_POST[buyer]', '$_POST[jam_terima]', '$_POST[acc_matching]', '$_POST[operator_penerima]', '$_POST[ket]', '$std_waktu', '$nama', GETDATE())";


    $q_simpan = sqlsrv_query($con, $query);
