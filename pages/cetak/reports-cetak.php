...
<tr valign="top">
        <td colspan="18"><strong>Periode: <?php echo $rTgl['tgl_skrg']; ?> s/d <?php echo $rTgl['tgl_skrg']; ?></strong><br />
        <strong>Shift: ALL</strong></td>
      </tr>
    <tr>
...
WHERE a.tgl_buat BETWEEN '$rTgl[tgl_skrg] 07:00' AND '$rTgl[tgl_besok] 07:00' ORDER BY no_mesin ASC");
   ...
   $c=0;
    ...
    while($rowd=mysqli_fetch_array($sql)){
      ...
      <td><?php echo $rowd['ket_status']; ?></td>
