        ...
        <td>
          ...
          <table width="100%" border="0">
            <tbody>
              <tr>
                <td width="78%">
                  <font size="-1">Hari/Tanggal : <?php echo tgl_indo($rTgl['tgl_skrg']->format('Y-m-d')); ?></font>
                </td>
                <td width="22%" align="right">Jam: <?php echo $rTgl['jam_skrg']->format('H:i:s'); ?></td>
              </tr>
            </tbody>
          </table>
        </td>
        ...
        <table width="100%" border="1" class="table-list1">
          <thead>
            <tr>
              ...
              <td width="13%" rowspan="2" scope="col">
          ...
          function tampil($mc, $no, $awal, $akhir)
          {
            include "../../koneksi.php";
            if ($awal != "") {
              $where = " AND CONVERT(datetime, tgl_update) BETWEEN '$awal' AND '$akhir' ";
            } else {
              $where = " ";
            }
          ...
          $data = sqlsrv_query($con, "SELECT b.* from db_dying.tbl_mesin b ORDER BY b.kapasitas DESC,b.no_mesin ASC OFFSET 3 ROWS
FETCH NEXT 5 ROWS ONLY");
          ...
          ?>
            <tr>
              ...
              <td valign="top" style="height: 0.35in;">
              ...
              <?php foreach (tampil($rowd['no_mesin'], "1", $Awal, $Akhir) as $dd) { ?>
                ...
                <td valign="top">
                  <div style="font-size: 8px;"><?php if (strlen($dd['jenis_kain']) > 25) {
                ...
                <td align="center" valign="top">
                  <div style="font-size: 8px;"><?php if (strlen($dd['warna']) > 25) {
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "2", $Awal, $Akhir) as $dd1) { ?>
                ...
                <td valign="top">
                  <div style="font-size: 8px;"><?php if (strlen($dd1['jenis_kain']) > 30) {
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "3", $Awal, $Akhir) as $dd2) { ?>
                ...
                <td valign="top">
                  <div style="font-size: 8px;"><?php if (strlen($dd2['jenis_kain']) > 30) {
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "4", $Awal, $Akhir) as $dd3) { ?>
                ...
                <td valign="top">
                  <div style="font-size: 8px;"><?php if (strlen($dd3['jenis_kain']) > 30) {
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "5", $Awal, $Akhir) as $dd4) { ?>
                ...
                <td valign="top">
                  <div style="font-size: 8px;"><?php if (strlen($dd4['jenis_kain']) > 30) {
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "6", $Awal, $Akhir) as $dd5) { ?>
                ...
                <td valign="top">
                  <div style="font-size: 8px;"><?php if (strlen($dd5['jenis_kain']) > 30) {
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "7", $Awal, $Akhir) as $dd6) { ?>
                ...
                <td valign="top">
                  <div style="font-size: 8px;"><?php if (strlen($dd6['jenis_kain']) > 30) {
    ...
    <tr>
      <td>
        <table width="100%" border="1" class="table-list1">
          ...
          <tr>
            <td>Tanggal</td>
            <td align="center"><?php echo tgl_indo($rTgl['tgl_skrg']->format('Y-m-d')); ?></td>
            <td align="center"><?php echo tgl_indo($rTgl['tgl_skrg']->format('Y-m-d')); ?></td>
            <td align="center"><?php echo tgl_indo($rTgl['tgl_skrg']->format('Y-m-d')); ?></td>
          </tr>
          <tr>
  ...
  <table width="100%" border="0">
    <tbody>
      ...
      <tr>
        <td>
          <pre>No. Revisi	: 16</pre>
        </td>
      </tr>
      <tr>
        <td>
          <pre>Tgl. Terbit	: 11 September 2020</pre>
        </td>
      </tr>
      <tr>
        <td>
          <pre>Halaman        : 1/16</pre>
        </td>
      </tr>
    </tbody>
  </table>
