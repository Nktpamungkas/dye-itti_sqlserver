...
LEFT JOIN tbl_mesin b ON a.no_mesin=b.no_mesin WHERE not a.`status`='selesai' GROUP BY a.no_mesin ORDER BY a.kapasitas DESC,a.no_mesin ASC"); */
	$data=mysqli_query($con,"SELECT b.* from tbl_mesin b ORDER BY b.kapasitas DESC,b.no_mesin ASC LIMIT 0,3");
	$no=1;
	$n=1;
	$c=0;
	 ?>
...
WHERE
	NOT STATUS = 'selesai'");
        ...
        Perbaikan: <?php echo "0"; ?> Lot<br>
        Gagal Proses : <?php echo "0"; ?> Lot<br>
        Tolak Basah : <?php echo "0"; ?> Lot
</div></td>
