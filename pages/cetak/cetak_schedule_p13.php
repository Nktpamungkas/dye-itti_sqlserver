    ...
    <tr>
      <td>
        <table width="100%" border="1" class="table-list1">
          ...
          $data = sqlsrv_query($con, "SELECT b.* FROM db_dying.tbl_mesin b ORDER BY b.kapasitas DESC,b.no_mesin ASC OFFSET 47 ROWS FETCH NEXT 4 ROWS ONLY");
          $no = 1;
          $n = 1;
          $c = 0;
          ?>
