    ...
    <tr>
      <td>
        <table width="100%" border="1" class="table-list1">
          ...
          $data = sqlsrv_query($con, "SELECT b.* FROM db_dying.tbl_mesin b ORDER BY b.kapasitas DESC,b.no_mesin ASC OFFSET 51 ROWS FETCH NEXT 4 ROWS ONLY");
          $no = 1;
          $n = 1;
          $c = 0;
          ?>
          ...
          ?>
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "2", $Awal, $Akhir) as $dd1) { ?>
                ...
                <td align="center" valign="top"><?php
                                                echo ($dd1['tgl_delivery'] != null or $dd1['tgl_delivery'] != '') ? $dd1['tgl_delivery']->format('Y-m-d H:i:s') : ''; ?></td>
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "3", $Awal, $Akhir) as $dd2) { ?>
                ...
                <td align="center" valign="top"><?php
                                                echo ($dd2['tgl_delivery'] != null or $dd2['tgl_delivery'] != '') ? $dd2['tgl_delivery']->format('Y-m-d H:i:s') : ''; ?></td>
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "4", $Awal, $Akhir) as $dd3) { ?>
                ...
                <td align="center" valign="top"><?php
                                                echo ($dd3['tgl_delivery'] != null or $dd3['tgl_delivery'] != '') ? $dd3['tgl_delivery']->format('Y-m-d H:i:s') : ''; ?></td>
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "5", $Awal, $Akhir) as $dd4) { ?>
                ...
                <td align="center" valign="top"><?php
                                                echo ($dd4['tgl_delivery'] != null or $dd4['tgl_delivery'] != '') ? $dd4['tgl_delivery']->format('Y-m-d H:i:s') : ''; ?></td>
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "6", $Awal, $Akhir) as $dd5) { ?>
                ...
                <td align="center" valign="top"><?php
                                                echo ($dd5['tgl_delivery'] != null or $dd5['tgl_delivery'] != '') ? $dd5['tgl_delivery']->format('Y-m-d H:i:s') : ''; ?></td>
            ...
            <tr>
              ...
              <?php foreach (tampil($rowd['no_mesin'], "7", $Awal, $Akhir) as $dd6) { ?>
                ...
                <td align="center" valign="top"><?php
                                                echo ($dd6['tgl_delivery'] != null or $dd6['tgl_delivery'] != '') ? $dd6['tgl_delivery']->format('Y-m-d H:i:s') : ''; ?></td>
    ...
    <tbody>
      <tr>
        ...
        <td width="13%">
          ...
          <pre>No. Revisi	: 15</pre>
          <pre>Tgl. Terbit	: </pre>
          <pre>Halaman        : 14/16</pre>
        </td>
      </tr>
    </tbody>
  </table>
