...
");
  ...
  while($rowd=sqlsrv_fetch_array($data)){
    if ($rowd === null) continue; // Skip if no data
    ...
    <tr>
      ...
      <td align="center" valign="top"style="font-size: 8px;"><?php 
        ...
        ?></td>      <td align="center" valign="top"><?php echo $dd1['rol']; ?></td>
    ...
    <tr>
      ...
      <td align="center" valign="top"style="font-size: 8px;"><?php 
        ...
        ?></td>      <td align="center" valign="top"><?php echo $dd2['rol']; ?></td>
    ...
    <tr>
      ...
      <td align="center" valign="top"style="font-size: 8px;"><?php 
        echo ($dd5['tgl_delivery'] != null && $dd5['tgl_delivery'] != '') ? $dd5['tgl_delivery']->format('Y-m-d') : ''; 
        ?></td>      
