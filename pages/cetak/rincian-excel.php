...
<body>
  ...
  if ($_GET['shft'] == "ALL") {
    ...
    $shft = " ISNULL(a.g_shift, b.g_shift) = '$_GET[shft]' AND ";
  }
  ...
  <table width="100%" border="0">
    ...
    while ($rowR = sqlsrv_fetch_array($sqlR)) {
      ...
      <tr style="border:1px solid;" bgcolor="<?php echo $bgcolor; ?>">
        ...
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trbadidas = $rowR['RBadidas'] + $rowR['RBadidas1']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trladidas = $rowR['RLadidas'] + $rowR['RLadidas1']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right">
    ...
    <tr style="border:1px solid;">
      ...
      <td bgcolor="#99FF99" style="border:1px solid;">
        <div align="right"><strong><?php echo $totalqt = $totqtyRB + $totqtyRB1 + $totqtyRL + $totqtyRL1; ?></strong>
        </div>
      </td>
      <td bgcolor="#99FF99" style="border:1px solid;">
  ...
  <table width="100%" border="0">
    ...
    $sqlx = sqlsrv_query($con, "SELECT
                                ...
                                FROM
                                    ...
                                    LEFT JOIN db_dying.tbl_hasilcelup a ON a.id_montemp = c.id
                                WHERE
                                    (CONVERT(date, a.tgl_buat) BETWEEN '$Awal' AND '$Akhir') AND
                                    k_resep='' 
                              GROUP BY
                                a.g_shift,
                                c.g_shift,
    ...
    <tr bgcolor="#99FF99" style="border:1px solid;">
      ...
      <td style="border:1px solid;">
        <div align="right">
          <strong><?php echo $toqadidas = $tqrbadidas + $tqrladidas + $tqrbadidas1 + $tqrladidas1; ?></strong></div>
      </td>
    </tr>
  </table>
  <br>
       ...
       FROM
        ...
        ORDER BY b.energi ASC");
          ...
          <tr bgcolor="#99FF99" style="border:1px solid;">
            ...
            <td style="border:1px solid;">
              <div align="right"><strong><?php echo $Ejamadidas . " Jam " . $Emenitadidas . " Menit"; ?></strong></div>
            </td>
            <td style="border:1px solid;">
          ...
          <tr bgcolor="#99FF99" style="border:1px solid;">
            ...
            <td style="border:1px solid;">
              <div align="right"><strong><?php echo $Ejamradidas . " Jam " . $Emenitradidas . " Menit"; ?></strong>
              </div>
            </td>
            <td style="border:1px solid;">
...
GROUP BY
                                                a.kd_stop,
                                                a.g_shift,
                                                b.g_shift  ORDER BY a.kd_stop ASC ");
...
GROUP BY 
                                              a.kd_stop,
                                              b.g_shift, 
                                              a.g_shift ORDER BY a.kd_stop ASC ");
